...
export const EditorPanel: React.FC<EditorPanelProps> = ({ value, onChange, onClear, onPasteSample, error }) => {
    return (
        <div className="flex flex-col h-full">
            <div className="flex justify-between items-center mb-2">
                <label htmlFor="json-editor" className="text-lg font-semibold text-slate-300">
                    Draft.js JSON Input
                </label>
